...
- source: `projects/reasoned-authoring-v1/level/candidate_v2.py`
- MAP sha256: `f4acda306f3d08abaf9d21db6def3390b119c4511016994d70646d210a5cfde7`
- counts: {'sectors': 31, 'walls': 167, 'sprites': 56, 'regions': 31, 'connections': 34}
...
- assemblies 1, spaces 14, singletons 9, detail groups 8
...
- decorative distribution: 0.2143 of 56 space sprites in one space
...
- sprite scale: measured, 18 oversized decoration(s)
  - sprite:6 (tile 506) in region:gate_tunnel is 1.95 player heights tall in a space 2.0 player heights clear, filling 98% of the available height
  - sprite:8 (tile 1044) in region:gatehouse is 5.82 player heights tall in a space 3.0 player heights clear, filling 194% of the available height
  - sprite:9 (tile 1044) in region:gatehouse is 5.82 player heights tall in a space 3.0 player heights clear, filling 194% of the available height
  - sprite:28 (tile 641) in region:chapel_aisle_south is 5.82 player heights tall in a space 4.0 player heights clear, filling 145% of the available height
  - sprite:30 (tile 641) in region:chapel_aisle_north is 5.82 player heights tall in a space 4.0 player heights clear, filling 145% of the available height
  - sprite:31 (tile 1044) in region:crypt_hall is 5.82 player heights tall in a space 2.18 player heights clear, filling 267% of the available height
  - sprite:32 (tile 1044) in region:crypt_hall is 5.82 player heights tall in a space 2.18 player heights clear, filling 267% of the available height
  - sprite:33 (tile 641) in region:crypt_hall is 5.82 player heights tall in a space 2.18 player heights clear, filling 267% of the available height
  - sprite:34 (tile 641) in region:crypt_hall is 5.82 player heights tall in a space 2.18 player heights clear, filling 267% of the available height
  - sprite:37 (tile 1701) in region:crypt_reliquary is 4.06 player heights tall in a space 2.0 player heights clear, filling 203% of the available height
  - sprite:38 (tile 641) in region:crypt_cistern is 5.82 player heights tall in a space 2.36 player heights clear, filling 246% of the available height
  - sprite:39 (tile 1044) in region:crypt_cistern is 5.82 player heights tall in a space 2.36 player heights clear, filling 246% of the available height
  - sprite:41 (tile 641) in region:ossuary is 5.82 player heights tall in a space 2.0 player heights clear, filling 291% of the available height
  - sprite:42 (tile 664) in region:gallery is 5.73 player heights tall in a space 6.0 player heights clear, filling 95% of the available height
  - sprite:43 (tile 664) in region:gallery is 5.73 player heights tall in a space 6.0 player heights clear, filling 95% of the available height
  - sprite:44 (tile 664) in region:gallery is 5.73 player heights tall in a space 6.0 player heights clear, filling 95% of the available height
  - sprite:45 (tile 664) in region:gallery is 5.73 player heights tall in a space 6.0 player heights clear, filling 95% of the available height
  - sprite:46 (tile 664) in region:gallery is 5.73 player heights tall in a space 6.0 player heights clear, filling 95% of the available height
...
- capture status: pass
- `view:start` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_start.png`
- `view:gate_approach` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_gate_approach.png`
- `view:gatehouse` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_gatehouse.png`
- `view:courtyard_center` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_courtyard_center.png`
- `view:chapel_interior` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_chapel_interior.png`
- `view:chapel_apse` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_chapel_apse.png`
- `view:crypt_hall` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_crypt_hall.png`
- `view:gallery_arch` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_gallery_arch.png`
- `view:gallery` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_gallery.png`
- `view:courtyard_from_stair` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_courtyard_from_stair.png`
- `view:chapel_reverse` pass -> `D:\Games\DOS\llmapper\projects\reasoned-authoring-v1\reports\v2\views\view_chapel_reverse.png`
