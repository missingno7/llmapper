...
Build renders ``picnum``, not the type name. Leaving pickups at tile 0 shows
the default/empty masonry tile. Values are the modal (type → picnum / repeat /
cstat / pal) counts from original ``maps/blood/E*.MAP`` campaign files.
"""
...
APPEARANCE: dict[int, dict[str, int]] = {
    ...
    21: {"picnum": 1070, "cstat": 464, "x_repeat": 40, "y_repeat": 40, "status": 0, "pal": 0},
    30: {"picnum": 570, "cstat": 384, "x_repeat": 64, "y_repeat": 64, "status": 0, "pal": 0},
    ...
    100: {"picnum": 2552, "cstat": 128, "x_repeat": 48, "y_repeat": 48, "status": 3},
    101: {"picnum": 2553, "cstat": 128, "x_repeat": 48, "y_repeat": 48, "status": 3},
    102: {"picnum": 2554, "cstat": 128, "x_repeat": 48, "y_repeat": 48, "status": 3},
    ...
    201: {"picnum": 3584, "cstat": 128, "x_repeat": 40, "y_repeat": 40, "status": 6, "pal": 0},
}
